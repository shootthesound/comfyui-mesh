...
const MESH_NODE_NAME = "MeshSplitLTX";
...
const LAST_USED_KEY = "comfyui-mesh.lastUsed.MeshSplitLTX";
...
function showHelpModal() {
    ...
    header.textContent = "ComfyUI Mesh : Icarus LTX — Tips & troubleshooting";
...
//   1. New-node default width (in setupMeshSplitLTX)
...
function setupMeshSplitLTX(node) {
