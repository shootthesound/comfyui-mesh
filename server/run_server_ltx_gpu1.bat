@echo off
REM Launcher: comfyui-mesh LTX back-half server pinned to GPU 1.
REM
REM Use this when ComfyUI is on GPU 0 of the same host and you want the
REM LTX back-half server on the second card.
...
REM Pin this process to the second GPU. After this line the server only
REM sees one card and addresses it as cuda:0.
set CUDA_VISIBLE_DEVICES=1
echo [run_server_ltx] pinned to physical GPU 1 (CUDA_VISIBLE_DEVICES=1)
