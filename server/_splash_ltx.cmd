...
REM pythonw; mesh_server_gui.py drops mesh_server_ltx_gui_ready.tmp once
...
echo.
echo   Starting ComfyUI Mesh : Daedalus LTX (WIP)...
echo.
...
:wait
if exist "%~dp0mesh_server_ltx_gui_ready.tmp" goto done
